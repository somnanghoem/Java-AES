...
public class AESUtil {
	 ...
	 * @throws Exception
	 */
	private static String makeKeyWithKeyData( String keyData ) throws Exception {
		...
		try {
			...
			byteKey = keyData.getBytes();
			final SecretKeySpec key = new SecretKeySpec( byteKey, ALGORITHM_AES );
			
			aesKey = Base64.getEncoder().encodeToString( key.getEncoded() ).replaceAll( "\n", "" );
